...
| **Промах (cache miss)** | Ответа в кеше нет, надо идти к медленному источнику | **Промах кеша чтения**, но  |
| **Попадание (cache hit)** | Ответ нашёлся в кеше | **Попадание кеша чтения**, но  |
