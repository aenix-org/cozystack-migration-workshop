...
Это не лаба. Здесь нечего разворачивать и нечего проверять скриптом — это разговор о том,
что делать дальше, когда стенд выключен, а на работе всё как было.

## Зачем это

Самая частая судьба такого обучения — «интересно, но у нас так не получится». Не потому,
что не получится, а потому, что после четырнадцати лаб непонятно, за какой конец браться в
своей инфраструктуре, где триста виртуалок и никто не помнит, что делает половина из них.

Разберём это по порядку: с чего начать, чего не трогать и как объяснить смысл тем, кто
подписывает бюджет.

## С чего начать: три кандидата
...
заявки. Разница в скорости будет очевидна обеим сторонам.
...
1. **Поднять стенд.** Не для миграции — чтобы было куда деться, когда захочется что-то
   проверить. Один сервер, одна установка, ноль обязательств.
...
**Стоимость лицензий** — самый очевидный, но и самый скользкий аргумент. Считайте честно:
...
- **Сообщество в Telegram** — там же, где проходил воркшоп. Вопрос «а как правильно
...
Хорошая новость в том, что собирать их можно постепенно, на одной системе за раз. Плохая —
что первые месяцы вы будете работать медленнее, чем привыкли. Это нормально и проходит.
