...
успели увидеть возврат в рамках лабы. В бою пять минут — разумнее.
...
⚠️ **Остановитесь и подумайте, прежде чем читать дальше.** Манифест применился без ошибок,
объект создан, `requests` у контейнера есть — мы только что смотрели. Чего не хватает?
...
Урок шире конкретной ошибки: **в Kubernetes «применено» и «работает» разделены во времени.**
