...
`metrics-server` — это та самая галочка **Monitoring agents**, которую лаба 0 просила
поставить при создании кластера. Если её пропустили, включите в дашборде: `Kubernetes` →
ваш кластер → изменить → раздел Addons. Ставить что-то руками не нужно.
