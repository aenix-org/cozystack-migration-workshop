...
| **Fortio** | Генератор нагрузки с веб-мордой | **HCIBench**, но живёт внутри кластера как обычное приложение |
...
| `fortio.yaml` | Генератор нагрузки с веб-мордой — им и разгоняем | применяете туда же |
