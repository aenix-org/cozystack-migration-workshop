...
|---|---|---|
| **Secret (Kubernetes)** | Объект кластера с данными, записанными в base64 | **Файл с паролем на диске VM**, но выглядит защищённым, но не защищён. Разбираем ниже отдельно |
...
| **Токен** | Временный пропуск к хранилищу | **Сессия**, но У него есть срок жизни, он протухает сам, его можно отозвать |
