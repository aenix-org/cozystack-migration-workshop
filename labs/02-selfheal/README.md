...
# И сразу смотрим, что осталось: обратите внимание на хеш в имени.
...
```bash
# Обратная операция к тому, что мы делали выше: заказываем одну копию вместо трёх.
# Две лишние кластер погасит сам, за секунды.
