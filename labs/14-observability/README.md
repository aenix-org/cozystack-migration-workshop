...
только с этого момента** — всплеск из лабы 3 вы уже не найдёте. Тогда после включения
повторите нагрузку из лабы 3 (`fortio.yaml`, страница генератора, `/`, 40 потоков на
пару минут) и возвращайтесь сюда.
...
Начнём с самого грубого вопрос: какие вообще поды видны в моём кластере.
