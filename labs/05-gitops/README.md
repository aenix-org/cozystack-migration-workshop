...
|---|---|---|
| **Репозиторий** | Один такой набор файлов с историей | **Папка с шаблонами на общем диске**, но У каждого своя полная копия, а не одна на всех |
...
| **GitRepository** | Объект в кластере: откуда брать состояние | **Настройка источника шаблонов**, но  |
