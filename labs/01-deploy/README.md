...
## Часть 2. Смотрим, во что превратилось нажатие
...
Вывод длинный и с непривычки страшный — не пугайтесь, большую часть кластер дописал сам.
Найдите глазами эти строки:
...
Приложение понадобится в лабах 2, 3 и 4 — сейчас не удаляем.
